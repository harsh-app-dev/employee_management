...
class DashboardController {
  ...
  final ValueNotifier<ApiState<List<TasksResponse>>> tasksApiState =
  ...
  Future<void> fetchTasks() async {
    ...
    try {
      ...
      if (result is NetworkSuccess<List<TasksResponse>>) {
        tasksApiState.value = ApiState.success(result.data);
      } else if (result is NetworkError<List<TasksResponse>>) {
